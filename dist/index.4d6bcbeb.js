...
const $num = (0, _jqueryDefault.default)("#num");
...
const $button4 = (0, _jqueryDefault.default)("#div2");
const n = localStorage.getItem("n");
$num.text(n || 100);
$button1.on("click", ()=>{
    let n1 = parseInt($num.text());
    n1 += 1;
    $num.text(n1);
    localStorage.setItem("n", n1);
});
$button2.on("click", ()=>{
    let n2 = parseInt($num.text());
    n2 -= 1;
    $num.text(n2);
    localStorage.setItem("n", n2);
});
$button3.on("click", ()=>{
    let n3 = parseInt($num.text());
    n3 *= 2;
    $num.text(n3);
    localStorage.setItem("n", n3);
});
$button4.on("click", ()=>{
    let n4 = parseInt($num.text());
    n4 /= 2;
    $num.text(n4);
    localStorage.setItem("n", n4);
});

},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./app1.css":"7FkZd"}],"hgMhh":[function(require,module,exports) {
/*!
...
$tabBar.children().eq(0).trigger("click") // 不要用.css(),不要用.hide()，不要用.show()
;

},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./app2.css":"8RnuD"}],"8RnuD":[function() {},{}],"264pe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./app3.css":"iOgrn","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iOgrn":[function() {},{}],"6ZENx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./app4.css":"jZ1KW","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jZ1KW":[function() {},{}]},["EtINM","gLLPy"], "gLLPy", "parcelRequiree44b")
